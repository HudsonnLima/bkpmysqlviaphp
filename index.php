...
<?php 
session_start();
require('./_app/Config.inc.php'); /*INCLUI ARQUIVO DE CONEXÃO COM O BANCO DE DADOS*/
$conn = mysqli_connect(HOST, USER, PASS, DBSA);/*CONSTANTES DEFINIDAS NO ARQUIVO DE CONEXÇÃO*/
